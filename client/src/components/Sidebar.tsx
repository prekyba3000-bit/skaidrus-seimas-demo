    ...
    >
      <div className="flex h-full flex-col justify-between p-6">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-emerald-400/70 text-xs font-medium tracking-wide uppercase">
        ...
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-900/20 border border-emerald-800/30">
          <div
            className="size-8 rounded-full bg-emerald-800 bg-cover bg-center border border-emerald-600"
            style={{
              backgroundImage:
                "url('https://lh3.googleusercontent.com/aida-public/AB6AXuC0gV4cuPRoag2RufZV8_ljJ1dGKPcPxMVHQIL5V8-zt5bSiE5Q6cV_ooojm4Ir_RMNyUK-Z3vGMkol0hmk5pRkmxULLZd2ZpeqYZ6yizv6HXptcG5qhJzhjxR4aFnkmi7IH6onnPbCoN4pnjTKIQ2leVg4SAVU4NYxRfbVyCsQmcPW8WEp_mWsWTn-dAnVPm4wRZyN_mkPuGFpLqZ4V-K4JugM-d99afyv0sPXA2_b_JJcjKlgJ_USYm74VSO6Nx4vlByC7xqAEKI')",
            }}
          ></div>
